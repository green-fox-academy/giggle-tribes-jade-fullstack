...
const selectQueries = {
    ...
    kingdomsData :
    'SELECT	kingdom.id kingdom_id, kingdom.name kingdomname, 1 population, location.code location FROM kingdom RIGHT JOIN location ON location.kingdom_id = kingdom.id'
};

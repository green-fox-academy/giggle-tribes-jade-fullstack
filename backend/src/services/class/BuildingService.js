export class BuildingService {
    ...
    setBuildingData({kingdomId,buildingType}) {
        ...
        const finish = new Date( start.getTime() + BuildingService.buildingStats[buildingType].time );
        this.buildingData = {
            id : null,
            kingdomId : kingdomId,
            type : buildingType,
            level : 1,
            hp : BuildingService.buildingStats[buildingType].hp,
    ...
    async add({kingdomId,buildingType}) {
        ...
        const {cost,gen} = BuildingService.buildingStats[buildingType]; 

export class ResourceService {
    ...
    async generateResources({kingdomId}) {
        ...
        resources.forEach( async resource => {
            ...
            await this.resources.update({amount: updateAmount, generation: resource.generation, kingdom_id : kingdomId, type : resource.type});
        });
    };
    ...
    async resourceUpdateFactory(kingdomId,resourceType) {
        ...
        return async (changeAmount,changeGeneration) => {
          await this.resources.update({amount: amount + changeAmount, generation: generation + changeGeneration, kingdom_id : kingdomId, type : resourceType});
        };
    };
